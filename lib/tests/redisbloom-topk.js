...
describe('RedisBloom Top-K filter testing', function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        it('reserve function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_topk_module_reserve(key1, 1, 2, 3, 0.1);
            chai_1.expect(response).to.equal('OK', 'The response of the TOPK.RESERVE command');
        }));
        it('add function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_topk_module_add(key1, ['bar', 42]);
            chai_1.expect(response[0]).to.equal(null, 'The response of the TOPK.ADD command');
        }));
        it('incrby function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal('bar', 'The response of the TOPK.INCRBY command');
        }));
        it('query function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal(1, 'The query response of key 42');
            chai_1.expect(response[1]).to.equal(0, 'The query response of key nonexist');
        }));
        it('count function', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(response[0]).to.equal(0, 'The response of the TOPK.COUNT command');
            chai_1.expect(response[1]).to.equal(2, 'The response of the TOPK.COUNT command');
            chai_1.expect(response[2]).to.equal(0, 'The response of the TOPK.COUNT command');
        }));
        it('list function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_topk_module_list(key1);
            chai_1.expect(response[0]).to.equal('42', 'The response of the TOPK.LIST command');
        }));
        it('info function', () => __awaiter(this, void 0, void 0, function* () {
            const response = yield redis.bloom_topk_module_info(key1);
            chai_1.expect(response.length).to.equal(8, 'The length of items in the response');
        }));
    });
});
